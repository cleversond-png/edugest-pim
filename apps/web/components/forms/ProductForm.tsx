...
function Input({
  ...
  return (
    <div>
      ...
      <input
        {...props}
        className="w-full rounded border border-gray-300 px-3 py-2 text-sm placeholder:text-gray-600 focus:border-blue-500 focus:outline-none"
      />
    </div>
  )
}
      ...
      <div className="space-y-2">
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 rounded border border-gray-300 px-3 py-2 text-sm placeholder:text-gray-600 focus:border-blue-500 focus:outline-none"
          />
          <button
            type="button"
            onClick={handleAdd}
      ...
      {faqs.map((faq: { pergunta: string; resposta: string }, idx: number) => (
        <div key={idx} className="rounded border border-gray-300 p-3 space-y-2">
          <input
            ...
            className="w-full rounded border border-gray-300 px-2 py-1 text-sm placeholder:text-gray-600"
          />
          <textarea
            value={faq.resposta}
            onChange={(e) => {
